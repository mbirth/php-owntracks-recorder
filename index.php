...
<html>
    <head>
        ...
        <script type="text/javascript" src="bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.<?=$_config['datepicker-language']?>.min.js"></script>
                ...
                */
                function initUI(){
                    ...
                    $('.input-daterange').datepicker({
                        format: 'yyyy-mm-dd',
                        language: '<?=$_config['datepicker-language']?>',
                        endDate: '0d',
                    });
